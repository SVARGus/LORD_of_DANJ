...
public:
	...
	void batlDanj(Monster mob); // расчет раунда и вывод на экран резултатов раунда // Позже процесс боевки выделить в отдельный класс для возможности гибкой настройки боя
